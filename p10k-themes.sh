...
load_theme() {
  case "$1" in
    ...
    "Catppuccin Mocha")
      ...
      dir_bg=111;  dir_fg=234;  dir_shortened_fg=236;  dir_anchor_fg=234
    ...
    "Catppuccin Macchiato")
      ...
      dir_bg=111;  dir_fg=235;  dir_shortened_fg=237;  dir_anchor_fg=235
    ...
    "Catppuccin Frappé")
      ...
      dir_bg=111;  dir_fg=236;  dir_shortened_fg=238;  dir_anchor_fg=236
    ...
    "One Dark")
      ...
      os_icon_fg=253;  os_icon_bg=75
      prompt_ok_fg=114;  prompt_error_fg=204
      dir_bg=75;  dir_fg=249;  dir_shortened_fg=249;  dir_anchor_fg=249
    ...
    "Tokyo Night")
      ...
      dir_bg=111;  dir_fg=189;  dir_shortened_fg=189;  dir_anchor_fg=189
    ...
    "Monokai")
      ...
      dir_bg=81;  dir_fg=235;  dir_shortened_fg=237;  dir_anchor_fg=235
    ...
    "Rosé Pine Moon")
      ...
      dir_bg=67;  dir_fg=189;  dir_shortened_fg=152;  dir_anchor_fg=189
    ...
    "Kanagawa")
      ...
      dir_bg=110;  dir_fg=187;  dir_shortened_fg=187;  dir_anchor_fg=187
    ...
    "Material Dark")
      ...
      dir_bg=111;  dir_fg=255;  dir_shortened_fg=255;  dir_anchor_fg=255
